...
Voir arduino/README.md pour le format attendu sur le port série.
"""
import json
import random
...
def lire_dht22():
    ...
    try:
        with serial.Serial(
            ...
            ligne = ligne_serie.readline().decode("utf-8").strip()
            donnees = json.loads(ligne)  # l'Arduino envoie une ligne JSON
            return {
        ...
        # Port série absent, Arduino débranché, ligne illisible... -> on simule
        return {
